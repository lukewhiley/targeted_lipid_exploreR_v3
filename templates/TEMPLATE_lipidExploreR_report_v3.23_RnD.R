...
#' 
#+ echo=FALSE, message=FALSE, fig.width=10, fig.height=5
subplot(master_list$pca_analysis$concentration_rsd_filtered$sample_qc$plot_scores, master_list$pca_analysis$concentration_rsd_filtered$plate$plot_scores)
#'
#'
#' 
#' ***
