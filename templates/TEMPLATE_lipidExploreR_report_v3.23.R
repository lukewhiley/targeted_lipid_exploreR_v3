#' ---
#' title: "Targeted Lipid ExploreR QC Report v3.23"
#' author: ANPC
...
#'  * Features are filtered with an RSD > 30% in replicate QCs
#' 
#' 
#+ echo=FALSE, message=FALSE, fig.width=10, fig.height=5
...
#' ***
#' 
#' ### Plot: PCA scores: post-statTarget signal drift/batch correction 
#' PCA scores plot displaying data that has undergone the following process steps: 
#' 
#'  * missing value filtering 
#'  * imputation of remaining missing values 
...
#'  * removal of lipids with RSD > 30% in replicate QC
#' 
#+ echo=FALSE, message=FALSE, fig.width=10, fig.height=5
subplot(master_list$pca_analysis$concentration_statTarget_rsd_filtered$sample_qc$plot_scores, master_list$pca_analysis$concentration_statTarget_rsd_filtered$plate$plot_scores)
#'
#'
#' 
#' ***
