...
master_list$summary_lists$list_pc_filter$pc_filter_plots <- append(
  master_list$summary_lists$list_pc_filter$pc_filter_plots,
  list(
  paste0(idx_data, "_PC1") = master_list$data$list_pc_filter[[idx_data]]$PC1$plotly,
  master_list$data$list_pc_filter[[idx_data]]$PC2$plotly,
  master_list$data$list_pc_filter[[idx_data]]$PC3$plotly
  )
)
...
htmltools::tagList(master_list$summary_lists$list_pc_filter$pc_filter_plots)
...
master_list$pc_run_plot$pre_corrected_data$all_features <- master_list$functions$run_order_plot$value(
  ...
  FUNC_plot_label = "sample_name",
  FUNC_scaling = "UV",
  FUNC_title = paste0("PC run order plot - pre-batch correction"),
...
master_list$pc_run_plot$post_corrected_data$all_features <- master_list$functions$run_order_plot$value(
  ...
  FUNC_plot_label = "sample_name",
  FUNC_scaling = "UV",
  FUNC_title = paste0("PC run order plot - post-batch correction"),
  FUNC_project_colours = c("white", "steelblue2"),
  FUNC_option_point_size = 3,
  FUNC_option_plot_qc = TRUE
)
