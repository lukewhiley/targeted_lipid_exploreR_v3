...
-> ~parent_directory/
  -> data/
    -> skyline_reports  #subfolder containing single csv per project/batch exported from skyline (skyline file export details below)
...
#### load packages
package_list <- c('svDialogs', 'plyr', 'tidyverse', 'ggpubr', 'janitor', 'shiny', 'plotly', 'effsize', 'dunn.test', 'RColorBrewer', 'statTarget', 'metabom8', 'rstatix', 'ggpubr', 'cowplot', 'knitr', 'stats', 'viridisLite', 'ggbeeswarm', 'mzR')
...
master_list$functions$pca <- source(paste0(master_list$project_details$github_master_dir,
                                           "/metabolomics_code/main/functions/2021_LGW_FUNC_PCA.R"))
#missing value filter
master_list$functions$miss_value_filter <- source(paste0(master_list$project_details$github_master_dir,
                                                  "/metabolomics_code/main/functions/2022_LGW_FUNC_lipid_missing_value_filter.R"))
#impute data
master_list$functions$impute_data <- source(paste0(master_list$project_details$github_master_dir,
                                                   "/metabolomics_code/main/functions/2022_LGW_FUNC_lipid_impute_data.R"))
#concentration calculator
master_list$functions$conc_calc <-  source(paste0(master_list$project_details$github_master_dir,
                                                  "/metabolomics_code/main/functions/2022_LGW_FUNC_lipid_conc_calculator.R"))
#pca qc filter
master_list$functions$pca_filter <- source(paste0(master_list$project_details$github_master_dir,
                                                  "/metabolomics_code/main/functions/2022_LGW_FUNC_lipid_pca_filter.R"))
#signal/batch correction
master_list$functions$signal_correct <- source(paste0(master_list$project_details$github_master_dir, 
                                                      "/metabolomics_code/main/functions/LGW_FUNC_signal_drift_correct_v0.2.R"))
#run order plot
master_list$functions$run_order_plot <- source(paste0(master_list$project_details$github_master_dir,
                                                      "/metabolomics_code/main/functions/2022_LGW_FUNC_lipid_pc_runorder_plot.R"))
...
master_list$pc_filter_plots <- append(
  ...
  lst(
  master_list$summary_lists$list_pc_filter$PC1$plotly,
  master_list$summary_lists$list_pc_filter$PC2$plotly,
  master_list$summary_lists$list_pc_filter$PC3$plotly,
  )
)
...
# fileConn<-file(paste0(master_list$project_details$project_dir, "/html_reports/report_template.r"))
# writeLines(httr::GET(url = paste0(master_list$project_details$github_master_dir, "/targeted_lipid_exploreR_v2/main/scripts/2021-LGW-lipidomics-report_generatoR_script_v2.r")) %>%
#                  httr::content(as = "text"), fileConn)
# close(fileConn)


rmarkdown::render(input = paste0(master_list$project_details$project_dir, "/html_reports/report_template_edited.r"),
