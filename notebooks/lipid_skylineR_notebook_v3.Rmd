...
test_object <- mrm_findR(FUNC_mzml_data_path = paste0(master_list$project_details$project_dir, "/data/mzml"),
         FUNC_mrm_guide = master_list$project_details$mrm_guide %>% 
           clean_names,
