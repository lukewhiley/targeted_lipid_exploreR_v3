...
master_list <- list(); master_list$project_details <- list(); master_list$functions <- list(); master_list$mzR <- list(); master_list$mrm_guides <- list(); master_list$skyline_reports <- list(); master_list$summary_tables <- list()
...
master_list$mrm_data$mrm_guide_rt_update <- master_list$functions$mrm_RT_findeR_mzR$value(
  ...
  FUNC_mrm_guide = master_list$mrm_data$mrm_guide %>% clean_names(),
  FUNC_OPTION_qc_type = "LTR",
  FUNC_OPTION_max_qc_replicates = 8)
#set names so that skyline recognises columns
master_list$mrm_data$mrm_guide_rt_update <- setNames(master_list$mrm_data$mrm_guide_rt_update,
                                                     names(master_list$mrm_data$mrm_guide))
