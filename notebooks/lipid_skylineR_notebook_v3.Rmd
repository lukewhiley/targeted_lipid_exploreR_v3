...
master_list$skyline_reports$report_1 <- read_csv(file = paste0(list.files(
...
master_list$mrm_data$mrm_guide_pb_update <- master_list$functions$mrm_pb_findeR$value(
  FUNC_data = master_list$skyline_reports$report_1 %>% clean_names(),
  FUNC_OPTION_qc_type = "LTR"
)

#write peak boundary output
write_csv(x = master_list$mrm_data$mrm_guide_pb_update,
...
#re_import skyline file
master_list$skyline_reports$report_2 <- read_csv(file = paste0(list.files(
  paste0(master_list$project_details$project_dir, "/skyline_reports"),
