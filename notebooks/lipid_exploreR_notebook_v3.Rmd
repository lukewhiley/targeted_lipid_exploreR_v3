...
master_list$functions$signal_correct <- source(paste0(github_master_dir,"/LGW_FUNC_signal_drift_correct_v0.2.R"))
...
for (idx_data in names(master_list$data$pc_filter)){
  ...
  master_list$data$corrected_individual_batch[[idx_data]] <- master_list$data$corrected_individual_batch[[idx_data]]$concentration_data
