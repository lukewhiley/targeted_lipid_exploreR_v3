...
```{r PCA plot of sorted raw data, eval = TRUE, echo = FALSE,  warning=FALSE, message=FALSE, include=TRUE, results='asis'}
...
master_list$pca_output$data_sorted[[idx_data]]$plot_scores
  }
...
```{r PC variation filter, eval = TRUE, echo = TRUE, warning=FALSE, error=FALSE, message=FALSE,  fig.width=1.25, fig.height=1}
...
print(master_list$summary_tables$corrected_individual_batch)
...
master_list$pca_output$corrected_individual_batch[[idx_data]] <- master_list$functions$pca$value(
  ...
  print(master_list$pca_output$corrected_individual_batch[[idx_data]]$plot_scores)
}
...
```{r Combine all data batch correct plot, eval = TRUE, echo = TRUE, warning=FALSE, error=FALSE, message=FALSE,  fig.width=1.25, fig.height=1}
...
print(master_list$summary_tables$all_batches_combined)
...
print(master_list$pca_output$final_dataset$post_corrected_data$plot_scores)
...
#step 3: print plots
master_list$pc_run_plot$pre_corrected_data
master_list$pc_run_plot$post_corrected_data
...
save(master_list,
     file = paste0(
       master_list$project_details$project_dir,
       "/data/rda_files/", Sys.Date(), "_master_list_checkpoint_7.rda"))
