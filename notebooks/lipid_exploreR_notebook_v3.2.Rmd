...
skylineR_script <- GET(url = paste0("https://raw.githubusercontent.com/lukewhiley/targeted_lipid_exploreR_v3/main /scripts/SCRIPT_lipidExploreR_qcCheckeR_v3.2.R")) %>% 
  content(as = "text")
